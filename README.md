...
```javascript
reim = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-reim@v0.1.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-reim@v0.1.3-umd/browser.js"></script>
```
